...
export interface WechatPlugin {
    ...
    shareImageMessage(options: ShareImage): Promise<{
        data: boolean;
    }>;
    shareMiniProgramMessage(options: ShareMiniProgram): Promise<{
        data: boolean;
    }>;
    shareTextMessage(options: ShareText): Promise<{
        data: boolean;
    }>;
    shareWebPageMessage(options: ShareWeb): Promise<{
        data: boolean;
    }>;
    shareVideoMessage(options: ShareVideo): Promise<{
        data: boolean;
    }>;
    shareMusicVideoMessage(options: ShareMusicVideo): Promise<{
        data: boolean;
    }>;
    auth(options: {
        scope: string;
    ...
    sendPaymentRequest(options: object): Promise<{
        data: boolean;
    }>;
